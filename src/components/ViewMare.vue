<template>
  <div id="view-mare">
    <ul class="collection with-header">
      ...
      >Comments(Previous Repro Problems, Previous Health Problems): {{comments}}</li>
      <li class="collection-item">Uterine Cysts: {{uterine_cysts}}</li>
    </ul>
    <button @click="deleteMare" class="btn-floating btn-large red">
    ...
    <div class="fixed-action-btn">
      ...
      <router-link
        v-bind:to="{name: 'edit-mare', params: {mare_id: mare_id}}"
